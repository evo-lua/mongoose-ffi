@echo OFF
cl /nologo /LD /O2 /I include /DMG_ENABLE_MD5 /DMG_ENABLE_IPV6 /DMG_ENABLE_LINES /DMG_ENABLE_OPENSSL mongoose/mongoose.c -o mongoose.dll /link /DEF:mongoose.def Ws2_32.lib libssl.lib libcrypto.lib
